...
PRODUCT_COPY_FILES += \
    device/lge/hammerhead/bluetooth/BCM43xx.hcd:$(TARGET_COPY_OUT_VENDOR)/firmware/bcm4335c0.hcd
...
PRODUCT_COPY_FILES += \
    ...
    device/lge/hammerhead/nfc/libnfc-nci-20791b05.conf:$(TARGET_COPY_OUT_SYSTEM)/etc/libnfc-nci-20791b05.conf
